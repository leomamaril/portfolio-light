  ...
  return (
    <Layout>
      ...
      <section className="aa-bg-white rounded-5" id="projects">
        <div className="row g-0 mx-3 mx-sm-4 mx-md-5 pt-5 align-items-center">
      ...
      <section className="" id="footer">
        <div className="footer">
          <div className="row g-0 justify-content-center align-items-center py-5 aa-bg-primary aa-text-white  text-center w-100">
